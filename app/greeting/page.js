...
const Greetings = () => {
  ...
  const createGreet = async () => {
    ...
    if (!trimmedGreet && trimmedMessage) {
      // Handle case where greet is empty but message is not
      return;
    }

    if (!trimmedGreet) {
      // Handle case where greet is empty
      return;
    }
              ...
              <div className="p-1 text-center">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditedGreet({ ...editedGreet, greet: e.target.value })
                    }
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditedGreet({ ...editedGreet, message: e.target.value })
                    }
                    className="mt-1 p-2 w-full border border-gray-300 rounded-md"
                  />
                </div>
