...
const Stock = () => {
    ...
    const fetchWaiterList = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/api/waiter/waiters"
        );
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-8 rounded shadow-md mt-10 font-sans">
      <h2 className="text-xl font-bold mb-6">Stock Outward Master</h2>
      ...
      <div className="mb-8">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-600">
              ...
              <Link href={"/waiter"}>
                ...
                <button className="text-white align-middle px-2 float-right font-bold  bg-red-500  text-l rounded-md">
        ...
        <button
          ...
          className="mt-4 bg-blue-500 text-white px-2 py-1 rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300"
        >
          Add Item
        </button>
      </div>
      ...
      <div>
        <button
          ...
          className="mt-4 bg-green-500 text-white px-4 py-1 rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300"
        >
          Save and Print
        </button>
      </div>
